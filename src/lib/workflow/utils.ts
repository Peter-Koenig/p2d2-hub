...
//
// Die reinen Tabellen-Namens-Mappings (resolveSourceTable/resolveVersionTable)
// liegen seit Turn 6 in @p2d2/core; hier bleiben die postgres-gekoppelten
// Teile (Spalten-Discovery, Feature-Daten, Stage-Auflösung, SQL-Identifier).
import type postgres from "postgres";
import type { FeatureData } from "../../types/workflow";
import { resolveSourceTable } from "@p2d2/core";

export { resolveSourceTable, resolveVersionTable } from "@p2d2/core";
